...
namespace KitBehaviorTree
{
    ...
    public class BehaviourTree : ScriptableObject
    {
        ...
        public static List<Node> GetChildren(Node parent)
        {
            ...
            if (parent is ConditionalNode conditional && conditional.child != null)
            {
        ...
        public void AddChild(Node parent, Node child)
        {
            ...
            if (parent is ConditionalNode conditional)
            {
        ...
        public void RemoveChild(Node parent, Node child)
        {
            ...
            if (parent is ConditionalNode conditonal)
            {
                Undo.RecordObject(conditonal, "Behaviour Tree (RemoveChild)");
                conditonal.child = null;
                EditorUtility.SetDirty(conditonal);
            }
