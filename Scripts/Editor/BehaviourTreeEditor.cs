...
namespace KitBehaviorTree
{
    public class BehaviourTreeEditor : EditorWindow
    {
        ...
        ToolbarButton miniMapToggleButton; //

        [MenuItem("MMORPG KIT/New Behaviour Tree")]
        ...
        public void CreateGUI()
        {
            ...
            List<BehaviourTree> behaviourTrees = LoadAssets<BehaviourTree>();
            ...
            // 
            miniMapToggleButton = root.Q<ToolbarButton>("miniMapButton"); //
            miniMapToggleButton.clicked += MiniMapToggle; //
