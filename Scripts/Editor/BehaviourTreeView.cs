...
namespace KitBehaviorTree
{
    public class BehaviourTreeView : GraphView
    {
        ...
        public ScriptTemplate[] scriptFileAssets = {
            ...
            new ScriptTemplate{ templateFile=BehaviourTreeSettings.GetOrCreateSettings().scriptTemplateConditionalNode, defaultFileName="NewConditionalNode.cs", subFolder="Conditions" },
        ...
        public BehaviourTreeView()
        {
            ...
            AddMinimap(); //
            StyleSheet styleSheet = settings.behaviourTreeStyle;
        ...
        public override void BuildContextualMenu(ContextualMenuPopulateEvent evt)
        {
            ...
            {
                TypeCache.TypeCollection types = TypeCache.GetTypesDerivedFrom<ConditionalNode>();
                foreach (var type in types)
                {
