...
//There are various 'hardcoded' settings for the behaviour tree editor. These can be accessed via the standard
//project settings menu under the 'Behaviour Tree' category
class BehaviourTreeSettings : ScriptableObject
{
    ...
    public string newNodeBasePath = "Assets/UnityMultiplayerARPG_BehaviorTree/";
